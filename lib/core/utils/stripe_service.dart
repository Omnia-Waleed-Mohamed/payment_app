...
import 'package:chechout_app/features/checkout/data/models/ephemeral_key_model/ephemeral_key_model.dart';
import 'package:chechout_app/features/checkout/data/models/init_payment_sheet_model.dart';
...
class StripeService {
  ...
  Future makePayment(
    ...
    var initPaymentSheetModel =InitPaymentSheetModel(clientSecret: paymentIntentModel.clientSecret!, customerId: paymentIntentInputModel.customerId, ephemeralKeySecret: ephemeralKeyModel.secret!);
